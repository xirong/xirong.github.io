...
const planetData = {
    ...
    rhea: {
        ...
        color: 0x9fa2b8,
        emissive: 0x5b6070,
        description: '土卫五是土星的一颗大型明亮冰质卫星，表面很亮，保存了很多古老的撞击坑。这里还给它画出一圈很淡的尘埃环，英文可以说 Rhea dust ring，也就是土卫五尘埃环。它不像土星光环那样明亮，更像非常稀薄的尘埃带。',
    ...
    saturn: {
        ...
        color: 0xead6b8,
        emissive: 0xc4a35a,
        description: '土星以其壮观的环系统而闻名，这些环主要由冰块和岩石碎片组成。土星的密度非常低，如果有一个足够大的浴缸，土星可以漂浮在水面上！土星光环的英文通常叫 Saturn\'s rings，也可以说 rings of Saturn，从远处看像一圈又一圈亮亮的带子。',
        relativeSize: 9.45,
        orbitRadius: 175,
        hasRings: true,
        moonCount: 146,
    ...
    uranus: {
        ...
        color: 0x7de8d5,
        emissive: 0x3a9a8c,
        description: '天王星是一颗"躺着"转的行星，它的自转轴几乎与公转轨道平面平行。它呈现出美丽的蓝绿色，这是因为大气中的甲烷吸收了红光。天王星也有很暗的光环，英文叫 Uranian rings，也可以说 rings of Uranus，主要由很黑的尘埃和小颗粒组成。',
        relativeSize: 4.0,
        orbitRadius: 220,
        hasRings: true,
        moonCount: 28,
...
const planetAudioNarration = {
    ...
    rhea: '土卫五，Rhea，土星的一颗大型冰质卫星，表面很亮、布满陨石坑和断裂带，和木星土星系内卫星相比表面保存得相对完整。这里画出的淡淡光环，英文可以说 Rhea dust ring，也就是土卫五尘埃环。它不像土星光环那样明亮，更像非常稀薄的尘埃带，帮助我们理解卫星旁边也可能有环状物质。',
